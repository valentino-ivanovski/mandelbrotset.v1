...
## Setup (Instructions only for IntelliJ Idea)
...
5. Next, you need to add the entire folder named "lib" as a library to idea. Same process as above, just select the entire folder.
